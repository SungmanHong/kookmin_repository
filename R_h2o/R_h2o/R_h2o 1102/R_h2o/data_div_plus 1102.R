...
full_data <- read.csv('./plus/full_data1102_plus.csv', encoding = 'EUC-KR')
head(full_data)
...
full_data.general$W_27 <- gsub("42년", "42", full_data.general$W_27)
full_data.general$W_27 <- gsub("43년", "43", full_data.general$W_27)
full_data.general$W_27 <- gsub("44년", "44", full_data.general$W_27)
full_data.general$W_27 <- gsub("45년", "45", full_data.general$W_27)
full_data.general$W_27 <- gsub("46년", "46", full_data.general$W_27)
full_data.general$W_27 <- gsub("47년", "47", full_data.general$W_27)
...
full_data.priorty$W_27 <- gsub("42년", "42", full_data.priorty$W_27)
full_data.priorty$W_27 <- gsub("43년", "43", full_data.priorty$W_27)
full_data.priorty$W_27 <- gsub("44년", "44", full_data.priorty$W_27)
full_data.priorty$W_27 <- gsub("45년", "45", full_data.priorty$W_27)
full_data.priorty$W_27 <- gsub("46년", "46", full_data.priorty$W_27)
full_data.priorty$W_27 <- gsub("47년", "47", full_data.priorty$W_27)
...
## W_1, W_6, W_14, W_32, W_33, W_34 제거
highage_26 <- highage_26[, !names(highage_26) %in% c("W_1", "W_6", "W_14", "W_32", "W_33", "W_34")]
...
## W_1, W_6, W_14, W_32, W_33, W_34 제거
disabled_26 <- disabled_26[, !names(disabled_26) %in% c("W_1", "W_6", "W_14", "W_32", "W_33", "W_34")]
...
# W_1, W_6, W_14, W_32, W_33, W_34 제거
married_46 <- married_46[, !names(married_46) %in% c("W_1", "W_6", "W_14", "W_32", "W_33", "W_34")]
...
## W_1, W_6, W_14, W_32, W_33, W_34 제거
general_26 <- general_26[, !names(general_26) %in% c("W_1", "W_6", "W_14", "W_32", "W_33", "W_34")]
general_36 <- general_36[, !names(general_36) %in% c("W_1", "W_6", "W_14", "W_32", "W_33", "W_34")]
general_46 <- general_46[, !names(general_46) %in% c("W_1", "W_6", "W_14", "W_32", "W_33", "W_34")]

write.table(highage_26, './plus/highage_26_plus.csv')
write.table(highage_36, './plus/highage_36_plus.csv')
write.table(highage_46, './plus/highage_46_plus.csv')
write.table(disabled_26, './plus/disabled_26_plus.csv')
write.table(disabled_36, './plus/disabled_36_plus.csv')
write.table(disabled_46, './plus/disabled_46_plus.csv')
write.table(married_46, './plus/married_46_plus.csv')
write.table(general_26, './plus/general_26_plus.csv')
write.table(general_36, './plus/general_36_plus.csv')
write.table(general_26, './plus/general_46_plus.csv')
